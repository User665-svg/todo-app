...
export function restoreTasks(stored) {
    ...
    for (const [idStr, t] of Object.entries(stored)) {
        ...
        const task = Object.assign(Object.assign(Object.assign(Object.assign({ title: t.title, content: t.content, dueDate: new Date(t.dueDate), isDone: t.isDone, updatedAt: new Date(t.updatedAt), createdAt: new Date(t.createdAt) }, (t.priority !== undefined && { priority: t.priority })), (t.repeat !== undefined && { repeat: t.repeat })), (t.isTemplate !== undefined && { isTemplate: t.isTemplate })), (t.seriesId !== undefined && { seriesId: t.seriesId }));
